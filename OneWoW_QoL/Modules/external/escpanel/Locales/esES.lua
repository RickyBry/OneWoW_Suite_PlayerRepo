...
OneWoW.Locale:Register(M._scope, "esES", {
    ...
    ["ESCPANEL_DESC"] = "Muestra una ficha de personaje, las colecciones y notas de este lugar, y una tira de portales junto al menu ESC. La ficha muestra el correo, la durabilidad, la Gran camara y el Puesto comercial, con Proyectos opcionales. La ficha del lugar tiene iconos de Alerta de objeto para Shopping List, notas, Trackers y Farming. Los aciertos van a la izquierda de |, el resto a la derecha. Pasa el cursor para ver detalles; haz clic en un acierto para abrirlo. Haz clic en ella para abrir la ventana de personaje, o en la ficha del lugar para abrir esa zona en el Catalogo. Elige abajo que lado usa cada uno.",
