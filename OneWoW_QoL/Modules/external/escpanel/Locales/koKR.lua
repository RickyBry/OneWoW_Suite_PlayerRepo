...
OneWoW.Locale:Register(M._scope, "koKR", {
    ...
    ["ESCPANEL_DESC"] = "ESC 메뉴 옆에 캐릭터 카드, 이 장소의 수집품과 쪽지, 차원문 띠를 표시합니다. 캐릭터 카드에는 우편, 내구도, 위대한 금고, 교역소가 나오며, 교류회는 선택 사항입니다. 장소 카드의 아이템 알림 아이콘은 Shopping List, 쪽지, Trackers, 파밍을 표시합니다. 적중은 | 왼쪽, 나머지는 오른쪽에 둡니다. 아이콘에 마우스를 올리면 자세한 내용이 나오고, 적중을 클릭하면 엽니다. 캐릭터 카드를 클릭하면 캐릭터창이 열리고, 장소 카드를 클릭하면 해당 지역이 카탈로그에서 열립니다. 아래에서 각 항목이 사용할 쪽을 선택하세요.",
