...
**If you use Catalog**, also copy all `OneWoW_CatDB_*` folders or those tabs will look empty.
...
| **Catalog data** | `OneWoW_CatDB_*` (Classic through Midnight, Other, Tradeskills) |
